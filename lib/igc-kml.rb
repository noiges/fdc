...
class IGCConverter
  ...
  # @raise [IgcKml::FileLoadingError] If file could not be loaded
  # @raise [IgcKml::FileFormatError] If the file format is invalid
    ...
    xml.kml "xmlns" => "http://www.opengis.net/kml/2.2", "xmlns:gx" => "http://www.google.com/kml/ext/2.2" do
      xml.Placemark {
        ...
        xml.gx:Track do
          ...
          @b_records.each do |b_record|
            coords = IgcKml::GeoLocation.to_dec(b_record[5], b_record[4])
  ...
  def export(dir = "")
    ...
    begin
      ...
      raise IgcKml::FileWritingError, "Destination is write-protected: " << dir.to_s
    rescue Errno::ENOTDIR => e
      raise IgcKml::FileWritingError, "Destination is not a directory: "  << dir.to_s
    rescue Errno::ENOENT => e
      raise IgcKml::FileWritingError, "Destination does not exist: " << dir.to_s
    end
